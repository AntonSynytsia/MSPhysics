module MSPhysics
  class Material
    ...
    #   is clamped between +0.01+ and +2.0+.
    ...
    def initialize(name, density, static_friction, kinetic_friction, elasticity, softness)
      ...
      @static_friction = MSPhysics.clamp(static_friction, 0.01, 2.0)
      @kinetic_friction = MSPhysics.clamp(kinetic_friction, 0.01, 2.0)
      @elasticity = MSPhysics.clamp(elasticity, 0.01, 2.0)
      @softness = MSPhysics.clamp(softness, 0.01, 1.0)
    end
