module MSPhysics
  ...
  class World
    ...
    def get_threads_count
      World.validate(self)
      MSPhysics::Newton::World.get_threads_count(@address)
    end

    # Set the number of threads to be used by the world.
    ...
    def set_threads_count(count)
      World.validate(self)
      MSPhysics::Newton::World.set_threads_count(@address, count.to_i)
    end
