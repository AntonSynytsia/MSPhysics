module MSPhysics
  ...
  class Common
    ...
    # @return [World]
    def world
      MSPhysics::Simulation.instance.get_world
    end
    ...
    # @return [Fixnum]
    def frame
      MSPhysics::Simulation.instance.get_frame
    end
    ...
    # @return [Sound, nil] A Sound object if successful.
    def play_sound(name)
    end

    # Play embedded music by name.
    # @return [Music, nil] A Music object if successful.
    def play_music(name)
    end
