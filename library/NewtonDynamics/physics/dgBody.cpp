...
void dgBody::SetMassMatrix(dgFloat32 mass, dgFloat32 Ixx, dgFloat32 Iyy, dgFloat32 Izz)
{
	...
	if (mass >= DG_INFINITE_MASS) {
		...
		dgFloat32 Ixx1 = dgClamp (Ixx, dgFloat32 (0.0001f) * mass, dgFloat32 (10000.0f) * mass);
		dgFloat32 Iyy1 = dgClamp (Iyy, dgFloat32 (0.0001f) * mass, dgFloat32 (10000.0f) * mass);
		dgFloat32 Izz1 = dgClamp (Izz, dgFloat32 (0.0001f) * mass, dgFloat32 (10000.0f) * mass);
