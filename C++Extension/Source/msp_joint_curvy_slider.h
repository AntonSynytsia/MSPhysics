#ifndef MSP_CURVY_SLIDER_H
#define MSP_CURVY_SLIDER_H
...
private:
	...
	// Structures
	typedef struct CurvySliderData {
...
public:
	...
	static bool c_calc_curve_data_at_location(const CurvySliderData* cj_data, const dVector& location, dVector& point, dVector& vector, dFloat& distance, dVector& min_pt, dVector& max_pt, dFloat& min_len, dFloat& max_len);
	static bool c_calc_curve_line_by_pos(const CurvySliderData* cj_data, dFloat distance, dVector& point, dVector& vector);
