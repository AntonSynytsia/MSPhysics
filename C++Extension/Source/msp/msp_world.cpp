...
int MSP::World::aabb_overlap_callback(const NewtonMaterial* const material, const NewtonBody* const body0, const NewtonBody* const body1, int thread_index) {
...
VALUE MSP::World::rbf_set_solver_model(VALUE self, VALUE v_world, VALUE v_solver_model) {
	...
	NewtonSetSolverModel(world, world_data->m_solver_model);
	return Qnil;
}
