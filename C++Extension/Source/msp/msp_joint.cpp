...
VALUE MSP::Joint::rbf_connect(VALUE self, VALUE v_joint, VALUE v_child) {
	...
	joint_data->m_constraint = NewtonConstraintCreateUserJoint(joint_data->m_world, joint_data->m_dof, submit_constraints, get_info, joint_data->m_child, joint_data->m_parent);
